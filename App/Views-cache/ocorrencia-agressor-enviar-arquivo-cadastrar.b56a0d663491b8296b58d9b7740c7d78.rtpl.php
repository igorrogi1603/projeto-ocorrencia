  ...
  <section class="content">
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <form action="/ocorrencia-agressor-enviar-arquivo-cadastrar/<?php echo htmlspecialchars( $idOcorrencia, ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">          
