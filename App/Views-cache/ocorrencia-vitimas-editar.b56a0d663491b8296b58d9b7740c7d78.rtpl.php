      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <a href="/ocorrencia" class="btn btn-app"><i class="fa fa-edit"></i>Editar Vítima</a>

            <a href="/ocorrencia-vitimas" class="btn btn-app"><i class="fa fa-user"></i>Editar Responsavel</a>

            <a href="/ocorrencia-vitimas" class="btn btn-app"><i class="fa fa-eye"></i>Ver Arquivos</a>
