...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Reabrir Apuração</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li class="active">Reabrir Apuração</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Relatótio para Reabrir Apuração com <strong>id: <?php echo htmlspecialchars( $idApuracao, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong></h3>
      </div>
      ...
      <div class="box-body">
        ...
        <form action="/apuracao-excluida-detalhe/reabrir/<?php echo htmlspecialchars( $idApuracaoExcluida, ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label for="id-descricao-da-ocorrencia">Descrição do porque está reabrindo a apuração *</label>
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="/apuracao-excluida-detalhe/<?php echo htmlspecialchars( $idApuracao, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary pull-left margin" id="botaoCancelar">Cancelar</a>
