...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Apurações Excluidas</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li class="active">Apuraçôes Excluidas</li>
    </ol>
  </section>
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/apuracao-excluida-detalhe/<?php echo htmlspecialchars( $value1["idCriarApuracao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-default"><i class="fa fa-edit"></i></a>
                </td>
              </tr>
              <?php } ?>
              <?php } ?>
