  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Relatótio de Exclusão do Agressor com <strong>id: <?php echo htmlspecialchars( $agressor["0"]["idOcorrenciaAgressor"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong></h3>
      </div>
      ...
      <div class="box-body">
        ...
        <form action="/ocorrencia-agressor-excluir/<?php echo htmlspecialchars( $idOcorrencia, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $isInstituicao, ENT_COMPAT, 'UTF-8', FALSE ); ?>/{agressor.0.$idOcorrenciaAgressor}/<?php echo htmlspecialchars( $agressor["0"]["idAgressor"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="descricaoAgressor" id="id-descricao-agressor" class="form-control" rows="10" onblur="validarEnivar()" required></textarea>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="/ocorrencia-agressor/<?php echo htmlspecialchars( $idOcorrencia, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary pull-left margin" id="botaoCancelar">Cancelar</a>
