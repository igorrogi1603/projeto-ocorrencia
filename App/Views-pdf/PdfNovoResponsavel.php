...
<body>
    ...
    <div class='container-total'>
        ...
        <div class='conteudo'>";
            ...
            $pagina .= "<p>Novo(a) responsável criado, apresenta-se pelo nome ".utf8_encode($post['nomeResponsavel']).", sendo";
            ...
            Reside no CEP ".$post['cepResponsavel'].", conforme a Rua ".utf8_decode($post['ruaResponsavel']).", do 
            bairro ".utf8_decode($post['bairroResponsavel']).", número ".$post['numeroResponsavel'].", situado no 
            Estado ".utf8_decode($post['estadoResponsavel']).", na cidade ".utf8_decode($post['cidadeResponsavel']).", com 
            complemento ".utf8_decode($post['complementoResponsavel']).".</p>";
