...
<body>
    ...
    <div class='container-total'>
        ...
        if ($isInstituicao == 1) {
            ...
            $pagina .= "<p>O(a) agressor(a) EDITADO é um (A) INSTITUIÇÃO, tida pelo  
            nome ".$post['nomeAgressor'].", ";

            $pagina .= "portador(a) do CNPJ ".$post['cnpjAgressor'].". ";
        ...
        if ($isInstituicao == 0) {
            ...
            $pagina .= "<p>O(a) agressor(a) EDITADO é um (a) PESSOA FÍSICA, apresentando-se pelo 
            nome ".$post['nomeAgressor'].", ";
